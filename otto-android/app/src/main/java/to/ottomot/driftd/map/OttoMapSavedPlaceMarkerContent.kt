...
fun OttoMapSavedPlaceMarkerContent(
    ...
    Box(
        modifier
            .width(SavedPlacePinFrameWidth)
            .height(SavedPlacePinFrameHeight)
            .graphicsLayer {
                scaleX = totalScale
                scaleY = totalScale
        ...
        Image(
            ...
            modifier =
                Modifier
                    ...
                    .width(SavedPlacePinWidth)
                    .height(SavedPlacePinHeight)
                    .shadow(4.dp, spotColor = Color.Black.copy(alpha = 0.4f)),
        )
        Spacer(Modifier.align(Alignment.BottomCenter).height(SavedPlacePinHeight))
    }
}
